...
const TooltipBox: React.FC<TooltipBoxProps> = ({
  ...
  const arrowClass = {
    ...
    bottomLeft:
      "top-0 right-[5%] translate-y-[-54%]  border-b-white",
  }[position];
    ...
    <div className="relative group inline-block">
      ...
      >
        <div
          ...
          className="relative bg-white drop-shadow-[2px_4px_7px_#028b7e73] text-primary2 px-3 rounded-md py-2 text-sm font-medium whitespace-nowrap"
        >
          {text}
