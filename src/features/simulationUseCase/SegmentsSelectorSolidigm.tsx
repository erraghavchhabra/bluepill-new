...
const SegmentsSelectorCoreStack: React.FC<SegmentsSelectorProps> = ({
  ...
  const standardFunctions = useMemo(() => ['Engineering', 'Technical Operations'], []);
  ...
  const industryL2Map = useMemo(() => ({
    "Ai Ecosystem Partners": ["AI Hardware Providers", "Networking Providers" ],
    "Industry Partners": ["Healthcare", "Manufacturing"],
