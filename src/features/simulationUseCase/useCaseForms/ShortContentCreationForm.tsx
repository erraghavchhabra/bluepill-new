...
const ShortContentCreationForm: React.FC<ContentCreationFormProps> = ({ 
  onSubmit, 
  selectedSegmentIds, 
  personaFilters, 
  onBack,
    ...
    <div className="bg-white rounded-xl shadow-sm p-6">
      ...
      <div className="mb-6">
        <label htmlFor="contentTalkAbout" className="block text-sm font-medium text-gray-700 mb-2">
          What should the content talk about? (Detailed Brief)
        </label>
        <input          type="text"
          id="contentTalkAbout"
          className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
      ...
      <div className="mb-6">
        <label htmlFor="contentSubject" className="block text-sm font-medium text-gray-700 mb-2">
          What’s the main topic or hook? (Optional)
        </label>
        <input          type="text"
          id="contentSubject"
          className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
          ...
          placeholder='Optional headline or angle to explore. Example: "Al tools cut contract times in half" or "1-click insights for faster decisions"'
        />
      </div>
...
export default ShortContentCreationForm;
