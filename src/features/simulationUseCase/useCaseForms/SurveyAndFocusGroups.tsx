...
const SurveyAndFocusGroups: React.FC<InsightsFormProps> = ({
  onSubmit,
  selectedSegmentIds,
  personaFilters,
  onBack,
  ...
  return (
    <div className="w-full bg-gray_light rounded-tl-[30px] p-[30px] relative pb-16">
      <div>
        <h3 className="text-[28px] font-semibold text-black mb-3">Survey</h3>
        <p className="text-xs font-normal text-[#595E64]">
          Simulate a survey or focus group to get insights
        </p>
      </div>
      <div className="mb-6">
        {loading ? (
...
export default SurveyAndFocusGroups;
